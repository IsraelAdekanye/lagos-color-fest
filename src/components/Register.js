...
function Register() {
  ...
  return (
    ...
    <div className='row'>
      ...
      <label>Gender:</label>
      <input type="radio" id="male" value="male" name="gender"/><label for="male" className="light" onSelect={e=>setGender(e.target.value)}>Male</label><br/>
      <input type="radio" id="female" value="female" name="gender"/><label for="female" className="light" onSelect={e=>setGender(e.target.value)}>Female</label>
